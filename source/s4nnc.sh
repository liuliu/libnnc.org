...
for i in $(find ../../s4nnc/gym -name '*.swift') ; do
    ../../SourceKitten/.build/release/sourcekitten doc --single-file $i -- ../../s4nnc/gym/*.swift ../../s4nnc/gym/envs/*.swift ../../s4nnc/gym/policies/*.swift ../../s4nnc/gym/renders/*.swift > _s4nnc/$(basename $i .swift).json
done
